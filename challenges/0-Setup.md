...
1. Login and request the https://academy.training.wiz.io/path/wiz-for-threat-detection-and-response) Lab be created. This will take approximately 10 minutes.
